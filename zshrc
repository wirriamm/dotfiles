...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/Users/wirriamm/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/wirriamm/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/wirriamm/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
alias nscc="ssh will0046@ntu.nscc.sg"
